...
customer `README.txt`, stable `start.sh` bootstrap, versioned `agentctl`, `docker-compose.yml`, and
...
| `README.txt` | Customer quick-start guide included in curl and ZIP installations |
